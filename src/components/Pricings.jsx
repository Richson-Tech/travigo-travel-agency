    ...
    <div className='my-16 relative'>
        <div className='travigo-container'>
            <div className='grid items-center mb-11 md:mb-7 text-center gap-2'>
               ...
               <p className='text-xl lg:text-sm text-gray-90'>{text}</p> 
               <div className='ring-1 ring-slate-100 rounded-full py-1.5 px-2 flex items-center justify-between gap-5 my-5 shadow-md shadow-200'>
